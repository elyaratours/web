import { contactEmail, type Locale } from './i18n';
...
export const postTourReviewRequestCopy = {
  es: {
    ...
    message: [
      ...
      '',
      'Si te apetece, nos ayudaria mucho recibir una opinion honesta sobre tu experiencia a traves del canal externo que te indiquemos. Tu comentario debe reflejar solo lo que viviste realmente durante la visita.',
      '',
  ...
  en: {
    ...
    message: [
      ...
      '',
      'If you would like to, an honest review of your experience through the external channel we provide would help us a lot. Your comment should only reflect what you personally experienced during the visit.',
      '',
