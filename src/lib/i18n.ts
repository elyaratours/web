...
export const localeConfig = {
  ...
  en: {
    ...
    heroEyebrow: 'Granada guided tours',
    heroTitle: 'Granada guided tours and private cultural routes',
    homeSeoTitle: 'Granada Guided Tours | Private Alhambra and Albaicin Tours',
    heroText:
      'Private tours and cultural walking routes through the Alhambra, Albaicin, Sacromonte and historic center, with direct WhatsApp or email inquiry.',
    ...
    catalogIntro: 'Choose a Granada guided tour and request a private Alhambra, Albaicin, Sacromonte, viewpoint or historic center route adapted to language, pace and interests.',
    metaHome: 'Granada guided tours and private Alhambra, Albaicin, Sacromonte and historic center walking routes in English or Spanish.',
...
export const dayTripsContent = {
  es: {
    ...
    metaDescription:
      'Excursiones privadas de un dia a Granada con guia cultural, Alhambra o Centro Historico y Albaicin, ritmo adaptado y propuesta a medida.',
    eyebrow: 'Excursiones de un dia a Granada',
    title: 'Excursiones de un dia a Granada para grupos privados',
    intro:
      'Organiza un dia completo en Granada con una propuesta privada, cultural y flexible. Elegimos juntos la experiencia principal, el ritmo y los complementos para que el dia tenga sentido sin convertirse en una lista imposible de paradas.',
    ...
    secondaryCta: 'Ver propuestas de excursion',
    originsTitle: 'Propuestas de excursion privada',
    originsText: 'Estas rutas ayudan a concretar origen, horarios y experiencia principal. Si vienes desde otra ciudad, revisa tambien la comparativa de salidas desde Malaga o Cordoba.',
    chooseTitle: 'Que hacer en una excursion de un dia por Granada',
    chooseText: 'Construye el dia alrededor de una experiencia principal en Granada. La Alhambra y el Centro Historico con Albaicin se presentan como alternativas completas, no como una lista obligatoria para hacer todo en pocas horas.',
    completeTitle: 'Servicios opcionales para tu dia en Granada',
    completeText: 'Puedes anadir servicios opcionales para que el dia sea mas comodo, gastronomico o personalizado.',
    requestTitle: 'Consulta de excursion de un dia',
    requestText:
