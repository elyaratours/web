...
export const localeConfig = {
  es: {
    ...
    catalogIntro: 'Elige una visita guiada en Granada y, si vienes en grupo, solicita una experiencia privada por la Alhambra, el Albaicin o el centro historico.',
    metaHome: 'Visitas guiadas en Granada por la Alhambra, Albaicin, Sacromonte y centro historico. Tours privados y rutas culturales en espanol e ingles.',
  ...
  en: {
    ...
    catalogIntro: 'Choose a Granada guided tour and, if you are coming as a group, request a private route through the Alhambra, Albaicin or historic center.',
    metaHome: 'Granada guided tours through the Alhambra, Albaicin, Sacromonte and historic center. Private routes and cultural walking tours in English or Spanish.',
